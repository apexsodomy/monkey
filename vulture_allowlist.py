...
LOG4j  # unused variable (monkey/monkey_island/cc/services/reporting/issue_processing/exploit_processing/exploiter_descriptor_enum.py:55)
...
Log4jExploiter  # unused class (monkey/infection_monkey/exploit/log4j.py:17)
